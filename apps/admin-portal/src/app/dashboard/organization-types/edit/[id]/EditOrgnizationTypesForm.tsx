...
export const EditOrganizationTypesForm = () => {
  ...
  const onSubmit = (data: OrganizationTypeUpdateSchema) => {
    setOpenModal({
      header: 'Update',
      body: `Are you sure you want to update user ${orgType?.name}`,
      color: 'secondary',
      text: 'Update',
      action: async () => {
        ...
        <div className="flex gap-4 justify-end">
          ...
          <Button
            ...
            onPress={() => {
              setOpenModal({
                ...
                body: `Are you sure you want to delete the user: ${orgType.name} permanently?`,
                color: 'danger',
          ...
          <Button
            ...
            onPress={() => {
              setOpenModal({
                header: 'Recover',
                body: `Are you sure you want to recover the user: ${orgType.name}?`,
                color: 'success',
                text: 'Recover',
                action: async () => {
                  setLocalLoading(true);
