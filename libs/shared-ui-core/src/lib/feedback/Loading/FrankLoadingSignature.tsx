  ...
  return (
    <div className="text-[#6A59D1] flex gap-3">
        ...
        {[
          ...
          <path
            ...
            style={{
              ...
              strokeDashoffset: p.dash,
              animation: `draw ${p.duration}s linear ${p.delay}s forwards`,
            }}
          />
        ))}
      </svg>
      ...
      <div
        style={{
          opacity: 0,
          animation: 'revealLeftToRight 0.28s ease-in-out 1.72s forwards',
          marginTop: '1rem',
        }}
      >
        <Spinner color="current" variant="wave" size="lg" />
      </div>
