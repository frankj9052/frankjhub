...
const meta = {
  title: 'Shared-UI-Hero-SSR/General/Button/NoqButton',
  component: NoqButton,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component:
          'A customizable button component with theming, loading state, and optional icons, designed for consistent styling across different usage scenarios.',
      },
    },
