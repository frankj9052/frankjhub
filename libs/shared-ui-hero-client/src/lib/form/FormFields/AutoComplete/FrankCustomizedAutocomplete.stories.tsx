...
const meta = {
  title: 'Shared-UI-Hero-Client/Form/FormFields/AutoComplete/FrankCustomizedAutocomplete',
  component: FrankCustomizedAutocomplete,
  tags: ['autodocs'],
  parameters: {
    layout: 'centered',
    docs: {
  ...
  args: {},
} satisfies Meta<typeof FrankCustomizedAutocomplete>;
