import { OrganizationPaginatedResponse } from "../modules";
import { OrganizationSchema, OrganizationWithOrgTypeNameSchema } from "../modules/organization/organization.schema";

export const organizationDataExample: OrganizationSchema = {
...
export const organizationWithOrgTypeDataExample: OrganizationWithOrgTypeNameSchema = {
  id: 'a1b2c3d4-e5f6-7890-1234-56789abcdef0',
  name: 'North York Chinese Medicine Clinic',
  description: 'A clinic specializing in traditional Chinese medicine and acupuncture services.',
  orgTypeId: '9f3c6c4e-92b8-4a4c-9202-6a42a9bcd3e7', // 应为 orgType 表的 UUID
...
export const organizationPaginatedResponseDataExample: OrganizationPaginatedResponse = {
        data: [
        {
          id: 'org-uuid-123',
