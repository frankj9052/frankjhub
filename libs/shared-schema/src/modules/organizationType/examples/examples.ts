import { OrganizationTypeDto, OrganizationTypeRef } from '../entity';
...
export const organizationTypeRefDataExample: OrganizationTypeRef = {
  id: organizationTypeDataExample.id,
  name: organizationTypeDataExample.name,
  description: organizationTypeDataExample.description,
};
